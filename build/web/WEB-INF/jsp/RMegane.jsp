        ...
        <div id="page">
            ...
            <div><table style="width:100%">
                ...
                <table style="width:80%">
                    ...
                    <tr>
                    <form method="POST" action="IznajmiRM">
                        <td><input type="hidden" type="text" name="id" value="7"</td>
                ...
                <img src="http://i1.wp.com/carhireindex.com/wp-content/uploads/CarRentalGallery/1518183285_Renault-Megane-Main.png" style="width:70%">
            </div>
