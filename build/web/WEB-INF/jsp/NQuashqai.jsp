        ...
        <div id="page">
            ...
            <div><table style="width:100%">
                ...
                <table style="width:80%">
                    ...
                    <tr>
                    <form method="POST" action="IznajmiQ">
                        <td><input type="hidden" type="text" name="id" value="6"</td>
                ...
                <img src="https://www-asia.nissan-cdn.net/content/dam/Nissan/singapore/vehicles/newqashqai/colour_selector/metallic-black-Z11-tablet.png.ximg.m_12_h.smart.png" style="width:70%">
            </div>
