        ...
        <div id="page">
            ...
            <div> 
                <table style="width:100%">
                    ...
                    <c:forEach items="${listaOpreme}" var="oprema">
                        <tr>
                ...
                <table style="width:100%">
                    ...
                    <tr>                    
                    <form method="POST" action="IznjamiGPS">
                        <td><input type="hidden" type="text" name="GPS" value="1"></td>
                        ...
                        <td><input type="submit" name="GPS" value="IznajmiGPS"></td>
                    </form>
                    </tr>
                </table>
                 <table style="width:100%">
                    ...
                    <tr>                    
                    <form method="POST" action="IznajmiBuster">
                        <td><input type="hidden" type="text" name="Buster" value="2"></td>
                        <td><input type="text" name="Ime"></td>
                        <td><input type="text" name="Prezime"></td>
                        <td><input type="text" name="JMBG"></td>
                        <c:forEach items="${listaKorisnika}" var="korisnik">
                        ...
                        <td><input type="text" name="kor" placeholder="ID+1"</td>
                        <td><input type="submit" name="Buster" value="IznajmiBuster"></td>
                    </form>
                    </tr>
                </table>
                <table style="width:100%">
                    ...
                    <tr>                    
                    <form method="POST" form="IznjamiSedisteZaBebe">
                        <td><input type="hidden" type="text" name="SedisteZaBebe" value="3"></td>
                        <td><input type="text" name="Ime"></td>
                        <td><input type="text" name="Prezime"></td>
                        <td><input type="text" name="JMBG"></td>
                        <c:forEach items="${listaKorisnika}" var="korisnik">
                        ...
                        <td><input type="text" name="kor" placeholder="ID+1"</td>
                        <td><input type="submit" name="SedisteZaBebe" value="IznajmiSedisteZaBebe"></td>
                    </form>
                    </tr>
                </table>
            </div>
