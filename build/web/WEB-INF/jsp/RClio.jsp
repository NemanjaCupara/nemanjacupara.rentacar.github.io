        ...
        <div id="page">
            ...
            <div><table style="width:100%">
                ...
                <table style="width:80%">
                    ...
                    <tr>
                    <form method="POST" action="IznajmiR">
                        <td><input type="hidden" type="text" name="id" value="3"</td>
                ...
                <img src="https://cdn2.renaultretail.co.uk/assets/rr3/images/vehicles/new/renault-clio/range/renault-clio-mercury-650x330.png" style="width:70%">
            </div>
