        ...
        <div id="page">
            ...
            <div><table style="width:100%">
                ...
                <table style="width:80%">
                    ...
                    <tr>
                    <form method="POST" action="IznajmiM">
                        <td><input type="hidden" type="text" name="id" value="5"</td>
                ...
                <img src="https://voitures.com/wp-content/uploads/images_vehicules/opel_14merivacosmo2b_angularfront.png" style="width:70%">
            </div>
