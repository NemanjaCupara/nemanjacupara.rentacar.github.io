        ...
        <div id="page">
            ...
            <div><table style="width:100%">
                ...
                <table style="width:80%">
                    ...
                    <tr>
                    <form method="POST" action="IznajmiS">
                        <td><input type="hidden" type="text" name="id" value="4"</td>
                ...
                <img src="http://www.stickpng.com/assets/images/580b585b2edbce24c47b2cb8.png" style="width:70%">
            </div>
