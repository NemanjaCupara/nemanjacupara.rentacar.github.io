        ...
        <div id="page">
            ...
            <div><table style="width:100%">
                ...
                <table style="width:80%">
                    ...
                    <tr>
                    <form method="POST" action="IznajmiO">
                        <td><input type="hidden" type="text" name="id" value="2"</td>
                ...
                <img src="http://www.rentacarqueen.com/files/images/1510126982-opel_PNG41.png" style="width:70%">
            </div>
