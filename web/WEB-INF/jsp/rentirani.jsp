        ...
        <div id="page">
            ...
            <div>
                <table style="width:100%">
                    ...
                    <c:forEach items="${listaRentirani}" var="rentirani">

                        <tr>
                            <td>${rentirani.ime}</td>
                            <td>${rentirani.prezime}</td>
                            <td>${rentirani.jmbg}</td>
                            <td>${rentirani.proizvodjac}</td>
                            <td>${rentirani.automobili}</td>
                            <td>${rentirani.datumUzimanja}</td>
                            <td>${rentirani.datumVracanja}</td>
